...
#define LED_R_PORT			LED_PORT
#define LED_G_PORT			LED_PORT
#define LED_B_PORT			LED_PORT

#define LED_ON(Name)		IO_WR(LED_##Name, 1)
#define LED_OF(Name)		IO_WR(LED_##Name, 0)
...
typedef enum {
	...
	KEY_S1_S2_TAP  = KEY_FLAG_TAP  | KEY_NUM_S1 | KEY_NUM_S2,
	KEY_S1_S2_HOLD = KEY_FLAG_HOLD | KEY_NUM_S1 | KEY_NUM_S2,
