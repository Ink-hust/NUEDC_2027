...
void MainProcess(void)
{
	...
	LCD_Print(&blcd, 0, 16 * 0, "TIM PWM (comp)");
	LCD_Print(&blcd, 0, 16 * 1, "Freq: 10 kHz");
	LCD_Print(&blcd, 0, 16 * 2, "Duty: 20.0%% (-2.0%%)");
	LCD_Print(&blcd, 0, 16 * 3, "Dead: 2 us");
	LCD_Print(&blcd, 0, 16 * 4, "Pin:  PB14/15");
