...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DDS_UPD_Pin|DDS_SCL_Pin|DDS_SDA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DDS_CS_Pin|DDS_RST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : DDS_UPD_Pin DDS_CS_Pin DDS_RST_Pin */
  GPIO_InitStruct.Pin = DDS_UPD_Pin|DDS_CS_Pin|DDS_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : DDS_SCL_Pin DDS_SDA_Pin */
  GPIO_InitStruct.Pin = DDS_SCL_Pin|DDS_SDA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
